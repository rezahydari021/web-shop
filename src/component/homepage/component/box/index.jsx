...
export default function Box() {
    return (
        <div className='container-fluid text-center height-card '>
            <div className="row row-cols-2 row-cols-md-4 g-4">
                <div className="col">
                    <svg preserveAspectRatio="xMidYMid meet" data-bbox="21 41.657 157.001 114.861" viewBox="21 41.657 157.001 114.861" height="50px" width="50px" xmlns="http://www.w3.org/2000/svg" data-type="color" role="presentation" aria-hidden="true" aria-label=""><defs>
                ...
                <div className="col">
                    <svg preserveAspectRatio="xMidYMid meet" data-bbox="22 29.01 158 141.964" viewBox="22 29.01 158 141.964" height="50" width="50" xmlns="http://www.w3.org/2000/svg" data-type="color" role="presentation" aria-hidden="true" aria-label=""><defs><style>#comp-km3c06wy svg [data-color="1"] fill: #000000;
                ...
                <div className="col">
                    <svg preserveAspectRatio="xMidYMid meet" data-bbox="31.078 22 137.843 155.564" viewBox="31.078 22 137.843 155.564" height="50" width="50" xmlns="http://www.w3.org/2000/svg" data-type="color" role="presentation" aria-hidden="true" aria-label=""><defs><style>#comp-km3aqc4u svg [data-color="1"] fill: #000000;
                ...
                <div className="col">
                    <svg preserveAspectRatio="xMidYMid meet" data-bbox="18.037 24.249 169.427 148.092" viewBox="18.037 24.249 169.427 148.092" height="50" width="50" xmlns="http://www.w3.org/2000/svg" data-type="color" role="presentation" aria-hidden="true" aria-label=""><defs><style>#comp-km3aq0qx svg [data-color="1"] fill: #000000;
                        #comp-km3aq0qx svg [data-color="2"] fill: #751FFF;</style></defs>
                        <g>
